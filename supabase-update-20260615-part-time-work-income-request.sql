-- supabase-update-20260615-part-time-work-income-request.sql
-- Status: executed on Cash DB 2026-06-15.
-- Purpose:
-- - Allow aozora_school external part-time work income requests to create Cash
--   pending income requests.
-- - Does not approve/reject requests and does not create Cash transactions.
